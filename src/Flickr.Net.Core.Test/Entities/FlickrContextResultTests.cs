...
public class FlickrContextResultTests
{
...

    {
        ...
        var result = FlickrConvert.DeserializeObject<FlickrContextResult<NextPhoto, PrevPhoto>>(reader);
    ...
    public void JsonStringToFlickrContextResultSetPool()
    {
        ...
        var result = FlickrConvert.DeserializeObject<FlickrAllContextResult<Set, Pool>>(reader);
