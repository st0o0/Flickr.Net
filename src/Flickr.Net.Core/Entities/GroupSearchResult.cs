...
// void IFlickrParsable.Load(XmlReader reader) { if (reader.LocalName != "group") {
// UtilityMethods.CheckParsingException(reader); }

// while (reader.MoveToNextAttribute()) { switch (reader.LocalName) { case "nsid": GroupId =
// reader.Value; break;
...
// case "pool_count": PoolCount = reader.ReadContentAsInt(); break;
