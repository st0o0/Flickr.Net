...
// void IFlickrParsable.Load(System.Xml.XmlReader reader) { if (reader.LocalName != "groups") {
// UtilityMethods.CheckParsingException(reader); }

// while (reader.MoveToNextAttribute()) { switch (reader.LocalName) { case "per_page": PerPage =
...
// while (reader.LocalName == "group") { MemberGroupInfo member = new();
