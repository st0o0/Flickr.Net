...
// void IFlickrParsable.Load(System.Xml.XmlReader reader) { if (reader.LocalName != "pairs") {
...
// while (reader.LocalName == "pair") { Pair item = new(); ((IFlickrParsable)item).Load(reader);
// Add(item); }
