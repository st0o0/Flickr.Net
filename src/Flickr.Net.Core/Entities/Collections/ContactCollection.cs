...
// void IFlickrParsable.Load(XmlReader reader) { if (reader.LocalName != "contacts") {
...
// while (reader.LocalName == "contact") { Contact contact = new();
// ((IFlickrParsable)contact).Load(reader); Add(contact); }
