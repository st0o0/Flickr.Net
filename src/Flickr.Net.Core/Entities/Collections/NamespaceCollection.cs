...
// void IFlickrParsable.Load(System.Xml.XmlReader reader) { if (reader.LocalName != "namespaces") {
...
// case "per_page": case "perpage": PerPage = int.Parse(reader.Value,
// System.Globalization.NumberFormatInfo.InvariantInfo); break;
...
// while (reader.LocalName == "namespace") { Namespace ns = new();
// ((IFlickrParsable)ns).Load(reader); Add(ns); }
