...
// switch (reader.LocalName) { case "nsid": InstitutionId = reader.Value; break;

// case "date_launch": DateLaunched = UtilityMethods.UnixTimestampToDate(reader.Value); break;
...
// "name": InstitutionName = reader.ReadElementContentAsString(); break;

// case "urls": reader.Read(); while (reader.LocalName == "url") { var type =
// reader.GetAttribute("type"); var url = reader.ReadElementContentAsString(); switch (type) { case
// "site": SiteUrl = url; break;

// case "flickr": FlickrUrl = url; break;

// case "license": LicenseUrl = url; break; } } reader.Read(); break; } }
