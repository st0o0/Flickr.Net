...
// (reader.LocalName) { case "photos_ok": PhotosAccepted = reader.Value == "1"; break;

// case "videos_ok": VideosAccepted = reader.Value == "1"; break;

// case "images_ok": ImagesAccepted = reader.Value == "1"; break;

// case "screens_ok": ScreenshotsAccepted = reader.Value == "1"; break;

// case "art_ok": ArtIllustrationsAccepted = reader.Value == "1"; break;

// case "safe_ok": SafeItemsAccepted = reader.Value == "1"; break;

// case "moderate_ok": ModeratedItemsAccepted = reader.Value == "1"; break;

// case "resitricted_ok": RestrictedItemsAccepted = reader.Value == "1"; break;

// case "has_geo": GeoInfoRequired = reader.Value == "1"; break; } }
