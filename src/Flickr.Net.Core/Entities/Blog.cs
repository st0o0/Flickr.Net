...
// </summary>
// [JsonConverter(typeof(BoolConverter))] public bool NeedsPassword { get; set; }

// ///
// <summary>
// /// The service that his blog uses. See <see
// cref="IFlickrBlogs.GetServicesAsync(CancellationToken)"/> ///
// </summary>
// public string Service { get; set; }

// void IFlickrParsable.Load(System.Xml.XmlReader reader) { if (reader.LocalName != "blog") {
// UtilityMethods.CheckParsingException(reader); }

// while (reader.MoveToNextAttribute()) { switch (reader.LocalName) { case "id": BlogId =
// reader.Value; break;

// case "name": BlogName = reader.Value; break;

// case "url": BlogUrl = reader.Value; break;

// case "needspassword": NeedsPassword = reader.Value == "1"; break;

// case "service": Service = reader.Value; break;
