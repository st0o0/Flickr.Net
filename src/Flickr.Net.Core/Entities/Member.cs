...
// ///
// <summary>
// /// The icon URL for the users buddy icon. Calculated from the <see cref="IconFarm"/> and <see
// cref="IconServer"/>. ///
// </summary>
// public string IconUrl { get { return UtilityMethods.BuddyIcon(IconServer, IconFarm, MemberId); } }
