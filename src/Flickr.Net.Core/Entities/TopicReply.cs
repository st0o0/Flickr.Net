...
// while (reader.MoveToNextAttribute()) { switch (reader.LocalName) { case "id": ReplyId =
// reader.Value; break;
...
// case "lastedit": DateLastEdited = UtilityMethods.UnixTimestampToDate(reader.Value); break;
