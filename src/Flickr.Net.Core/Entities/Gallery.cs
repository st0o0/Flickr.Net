...
// </summary>
// public string OwnerBuddyIcon { get { return UtilityMethods.BuddyIcon(OwnerServer, OwnerFarm,
// OwnerId); } }
...
// </summary>
// public string PrimaryPhotoThumbnailUrl { get { return UtilityMethods.UrlFormat(PrimaryPhotoFarm,
// PrimaryPhotoServer, PrimaryPhotoId, PrimaryPhotoSecret, "thumbnail", "jpg"); } }

// ///
// <summary>
// /// The URL of the small image for the primary image for this gallery. ///
// </summary>
// public string PrimaryPhotoSmallUrl { get { return UtilityMethods.UrlFormat(PrimaryPhotoFarm,
// PrimaryPhotoServer, PrimaryPhotoId, PrimaryPhotoSecret, "small", "jpg"); } }

// ///
// <summary>
// /// The URL of the squrea thumbnail for the primary image for this gallery. ///
// </summary>
// public string PrimaryPhotoSquareThumbnailUrl { get { return
// UtilityMethods.UrlFormat(PrimaryPhotoFarm, PrimaryPhotoServer, PrimaryPhotoId,
// PrimaryPhotoSecret, "square", "jpg"); } }
...
// </summary>
// public string PrimaryPhotoMediumUrl { get { return UtilityMethods.UrlFormat(PrimaryPhotoFarm,
// PrimaryPhotoServer, PrimaryPhotoId, PrimaryPhotoSecret, "medium", "jpg"); } }

// void IFlickrParsable.Load(System.Xml.XmlReader reader) { while (reader.MoveToNextAttribute()) {
// switch (reader.LocalName) { case "id": GalleryId = reader.Value; break;

// case "url": if (reader.Value.IndexOf("www.flickr.com", StringComparison.Ordinal) > 0) {
// GalleryUrl = reader.Value.Replace("http://", "https://"); } else { GalleryUrl =
// "https://www.flickr.com" + reader.Value; }
...
// case "date_create": DateCreated = UtilityMethods.UnixTimestampToDate(reader.Value); break;

// case "date_update": DateLastUpdated = UtilityMethods.UnixTimestampToDate(reader.Value); break;

// case "primary_photo_id": PrimaryPhotoId = reader.Value; break;

// case "iconserver": OwnerServer = reader.Value; break;

// case "iconfarm": OwnerFarm = reader.Value; break;

// case "primary_photo_server": case "server": PrimaryPhotoServer = reader.Value; break;

// case "primary_photo_farm": case "farm": PrimaryPhotoFarm = reader.Value; break;

// case "primary_photo_secret": case "secret": PrimaryPhotoSecret = reader.Value; break;

// case "count_photos": PhotosCount = reader.ReadContentAsInt(); break;

// case "count_videos": VideosCount = reader.ReadContentAsInt(); break;

// case "count_views": ViewCount = reader.ReadContentAsInt(); break;

// case "count_comments": CommentCount = reader.ReadContentAsInt(); break;

// default: UtilityMethods.CheckParsingException(reader); break; } }

// reader.Read();

// while (reader.NodeType != System.Xml.XmlNodeType.EndElement) { switch (reader.LocalName) { case
// "title": Title = reader.ReadElementContentAsString(); break;
