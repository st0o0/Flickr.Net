...
// while (reader.MoveToNextAttribute()) { switch (reader.LocalName) { case "id": TopicId =
// reader.Value; break;
...
// case "iconserver": AuthorIconServer = reader.Value; break;

// case "iconfarm": AuthorIconFarm = reader.Value; break;

// case "count_replies": RepliesCount = reader.ReadContentAsInt(); break;
...
// case "last_reply": LastReplyId = reader.Value; break;

// case "group_id": GroupId = reader.Value; break;

// case "name": // Group Name break;
...
// case "lastedit": DateLastEdited = reader.Value == "" || reader.Value == "0" ? null :
