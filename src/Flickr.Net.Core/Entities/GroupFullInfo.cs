...
// ///
// <summary>
// /// The User ID for the user who last set the group's 'Blast' (the banner seen on the group home
// page). ///
// </summary>
...
// </summary>
// public string GroupIconUrl { get { return UtilityMethods.BuddyIcon(IconServer, IconFarm,
// GroupId); } }
...
// public static implicit operator Group(GroupFullInfo groupInfo) { Group g = new() { GroupId =
// groupInfo.GroupId, GroupName = groupInfo.GroupName, Members = groupInfo.Members };

// return g; }

// ///
// <summary>
// /// Converts the current <see cref="GroupFullInfo"/> into an instance of the <see cref="Group"/>
// class. ///
// </summary>
// ///
// <returns>A <see cref="Group"/> instance.</returns>
// public Group ToGroup() { return (Group)this; }

// void IFlickrParsable.Load(XmlReader reader) { while (reader.MoveToNextAttribute()) { switch
// (reader.LocalName) { case "nsid": case "id": GroupId = reader.Value; break;
...
// while (reader.LocalName != "group") { switch (reader.LocalName) { case "name": GroupName =
// reader.ReadElementContentAsString(); break;

// case "description": Description = reader.ReadElementContentAsString(); break;

// case "members": Members = reader.ReadElementContentAsInt(); break;

// case "privacy": Privacy = (PoolPrivacy)reader.ReadElementContentAsInt(); break;

// case "blast": BlastDateAdded =
// UtilityMethods.UnixTimestampToDate(reader.GetAttribute("date_blast_added")); BlastUserId =
// reader.GetAttribute("user_id"); BlastHtml = reader.ReadElementContentAsString(); break;

// case "throttle": ThrottleInfo = new GroupThrottleInfo();
// ((IFlickrParsable)ThrottleInfo).Load(reader); break;

// case "restrictions": Restrictions = new GroupInfoRestrictions();
// ((IFlickrParsable)Restrictions).Load(reader); break;

// case "roles": MemberRoleName = reader.GetAttribute("member"); ModeratorRoleName =
// reader.GetAttribute("moderator"); AdminRoleName = reader.GetAttribute("admin"); reader.Read(); break;

// case "rules": Rules = reader.ReadElementContentAsString(); break;

// case "pool_count": PoolCount = reader.ReadElementContentAsInt(); break;

// case "topic_count": TopicCount = reader.ReadElementContentAsInt(); break;
