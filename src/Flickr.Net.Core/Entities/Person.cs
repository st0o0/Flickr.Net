...
// ///
// <summary>
// /// Has the person marked the calling user as a contact. Will be null if not an authenticated
// call. ///
// </summary>
...
// ///
// <summary>
// /// Has the person marked the calling user as a friend. Will be null if not an authenticated
// call. ///
// </summary>
...
// </summary>
// public string BuddyIconUrl { get { return UtilityMethods.BuddyIcon(IconServer, IconFarm, UserId);
// } }
...
// void IFlickrParsable.Load(System.Xml.XmlReader reader) { LoadAttributes(reader);

// LoadElements(reader); }

// private void LoadElements(System.Xml.XmlReader reader) { while (reader.LocalName != "person") {
// switch (reader.LocalName) { case "username": UserName = reader.ReadElementContentAsString(); break;

// case "location": Location = reader.ReadElementContentAsString(); break;

// case "realname": RealName = reader.ReadElementContentAsString(); break;

// case "photosurl": PhotosUrl = reader.ReadElementContentAsString(); break;

// case "profileurl": ProfileUrl = reader.ReadElementContentAsString(); break;

// case "mobileurl": MobileUrl = reader.ReadElementContentAsString(); break;

// case "photos": PhotosSummary = new PersonPhotosSummary();
// ((IFlickrParsable)PhotosSummary).Load(reader); break;

// case "mbox_sha1sum": MailboxSha1Hash = reader.ReadElementContentAsString(); break;

// case "timezone": TimeZoneLabel = reader.GetAttribute("label"); TimeZoneOffset =
// reader.GetAttribute("offset"); reader.Read(); break;
...
// private void LoadAttributes(System.Xml.XmlReader reader) { while (reader.MoveToNextAttribute()) {
// switch (reader.LocalName) { case "id": case "nsid": UserId = reader.Value; break;

// case "ispro": IsPro = reader.Value == "1"; break;

// case "iconserver": IconServer = reader.Value; break;

// case "iconfarm": IconFarm = reader.Value; break;

// case "path_alias": PathAlias = reader.Value; break;

// case "gender": Gender = reader.Value; break;

// case "ignored": IsIgnored = reader.Value == "1"; break;

// case "contact": IsContact = reader.Value == "1"; break;

// case "friend": IsFriend = reader.Value == "1"; break;

// case "family": IsFamily = reader.Value == "1"; break;

// case "revcontact": IsReverseContact = reader.Value == "1"; break;

// case "revfriend": IsReverseFriend = reader.Value == "1"; break;

// case "revfamily": IsReverseFamily = reader.Value == "1"; break;

// case "can_buy_pro": CanBuyPro = reader.Value == "1"; break;

// case "has_stats": HasStats = reader.Value == "1"; break;

// case "expire": // TODO: Not sure what the 'expire' attribute signifies. Is it a Bool? break;
