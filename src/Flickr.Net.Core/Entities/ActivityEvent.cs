...
//{
//    /// <summary>
//    /// The <see cref="Enums.EventType"/> of the event, either Comment or Note.
//    /// </summary>
...
// (reader.LocalName) { case "type": switch (reader.Value) { case "fave": EventType =
// EventType.Favorite; break;

// case "note": EventType = EventType.Note; break;

// case "comment": EventType = EventType.Comment; break;

// case "added_to_gallery": EventType = EventType.Gallery; break;

// case "tag": EventType = EventType.Tag; break;

// case "group_invite": EventType = EventType.GroupInvite; break;

// default: UtilityMethods.CheckParsingException(reader); break; } break;

// case "user": UserId = reader.Value; break;

// case "username": UserName = reader.Value; break;

// case "dateadded": DateAdded = UtilityMethods.UnixTimestampToDate(reader.Value); break;

// case "commentid": CommentId = reader.Value; break;

// case "noteid": NoteId = reader.Value; break;

// case "galleryid": GalleryId = reader.Value; break;
...
// case "group_name": GroupName = reader.Value; break;

// case "is_muted": IsMuted = reader.Value == "1"; break;
