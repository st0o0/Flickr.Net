...
public partial class Flickr
{
    ...
    public async Task<ContactCollection> ContactsGetListAsync(ContactType filter = ContactType.None, int page = 0, int perPage = 0, CancellationToken cancellationToken = default)
    {
    ...
    public async Task<ContactCollection> ContactsGetListRecentlyUploadedAsync(ContactSearch filter = ContactSearch.AllContacts, DateTime? dateLastUpdated = null, CancellationToken cancellationToken = default)
    {
        CheckRequiresAuthentication();
    ...
    /// <param name="page">The page of results to return. If this argument is omitted, it defaults to 1.</param>
    /// <param name="perPage">Number of contacts to return per page. If this argument is omitted, it defaults to 1000. The maximum allowed value is 1000.</param>
    public async Task<ContactCollection> ContactsGetPublicListAsync(string userId, int page = 0, int perPage = 0, CancellationToken cancellationToken = default)
    {
        Dictionary<string, string> parameters = new()
        {
    ...
    /// <returns></returns>
    public async Task<ContactCollection> ContactsGetTaggingSuggestionsAsync(int page = 0, int perPage = 0, CancellationToken cancellationToken = default)
    {
        CheckRequiresAuthentication();
