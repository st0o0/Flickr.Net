...
public partial class Flickr
{
    ...
    public async Task<OAuthRequestToken> OAuthGetAccessTokenAsync(OAuthRequestToken requestToken, string verifier, CancellationToken cancellationToken = default)
    {
    ...
    /// <param name="verifier"></param>
    public async Task<OAuthRequestToken> OAuthGetAccessTokenAsync(string requestToken, string requestTokenSecret, string verifier, CancellationToken cancellationToken = default)
    {
        CheckApiKey();
