...
public class FlickrContextResultTests
{
    ...
    public void JsonStringToFlickrContextResult()
    {
        ...
        var result =
            FlickrConvert.DeserializeObject<FlickrContextResult<NextPhoto, PrevPhoto>>(Encoding.UTF8.GetBytes(json));
