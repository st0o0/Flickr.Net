...
public static class IBuddyIconExtensions
{
    ...
    public static string ToBuddyIconUrl(this IBuddyIcon value)
    {
        return value switch
        {
            ...
            Member member => UtilityMethods.BuddyIcon(member.IconServer, member.IconFarm, member.Id),
            ...
            Topic topic => UtilityMethods.BuddyIcon(topic.AuthorIconServer, topic.AuthorIconFarm, topic.Author),
