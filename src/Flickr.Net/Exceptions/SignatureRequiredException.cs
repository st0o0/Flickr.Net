...
/// </summary>
public sealed class SignatureRequiredException : FlickrException
{
    /// <summary>
    /// Initializes a new instance of the <see cref="SignatureRequiredException"/> class.
    /// </summary>
    public SignatureRequiredException() : base("Method requires signing but no shared secret supplied.")
    { }
