...
/// </summary>
public sealed class FlickrWebException : FlickrException
{
    /// <summary>
    ...
    public FlickrWebException(string message) : base(message)
    { }
    ...
    public FlickrWebException(string message, Exception innerException) : base(message, innerException)
    { }
}